...
public class NumberTheoryTest {
  ...
  public void testDiophantine(List<BigInteger> testCase) {
    BigInteger[] result =
        NumberTheory.solveDiophantine(testCase.get(0), testCase.get(1), testCase.get(2)).get();
  ...
  public static List<Pair<Map<BigInteger, BigInteger>, BigInteger[]>>
      getChineseRemaindersTestCases() {
