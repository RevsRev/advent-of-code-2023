...
public class EuclidTest {
  ...
  public static List<Pair<BigInteger[], List<BigInteger[]>>> getEuclidTestCases() {
    ...
    steps.add(
        new BigInteger[] {
          BigInteger.valueOf(5), BigInteger.valueOf(3), BigInteger.valueOf(1), BigInteger.valueOf(2)
        });
    steps.add(
        new BigInteger[] {
          BigInteger.valueOf(3), BigInteger.valueOf(2), BigInteger.valueOf(1), BigInteger.valueOf(1)
        });
    steps.add(
        new BigInteger[] {
          BigInteger.valueOf(2), BigInteger.valueOf(1), BigInteger.valueOf(2), BigInteger.valueOf(0)
        });
