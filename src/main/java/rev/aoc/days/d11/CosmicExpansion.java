...
public class CosmicExpansion extends AocSolution<Long> {
  ...
  private Set<Vec2> expand(
      Set<Vec2> galaxyPositions, List<Integer> expansionRows, List<Integer> expansionCols) {
  ...
  private Vec2 expandGalaxy(Vec2 galaxy, List<Integer> expansionRows, List<Integer> expansionCols) {
    ...
    return new Vec2(
        galaxy.x + timesToExpandX * expansionFactor, galaxy.y + timesToExpandY * expansionFactor);
  }
